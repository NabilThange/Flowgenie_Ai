      ...
      <Card className="w-full max-w-md bg-zinc-900/80 backdrop-blur-sm border-zinc-800 shadow-xl">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div className="space-y-2">
              <div className="flex items-center justify-between">
                ...
                <Link href="#" className="text-sm text-[#7B61FF] hover:text-[#A47CF3] transition-colors">
                  Forgot password?
                </Link>
              </div>
              <Input
        ...
        <CardFooter className="flex justify-center">
          <div className="text-sm text-zinc-500">
            ...
            <Link href="/signup" className="text-[#7B61FF] hover:text-[#A47CF3] font-medium transition-colors">
              Sign up
            </Link>
          </div>
        </CardFooter>
